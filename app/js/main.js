...
/*!**************************!*\
  !*** ./src/Main/Main.fs ***!
  \**************************/
/*! exports provided: mainWindow, menuBuilder, ch, newMenu, makeItem, createMainWindow */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "newMenu", function() { return newMenu; });
...
function makeItem(label, accelerator) {
  ...
  var item$$1 = {};
  item$$1.label = label;
  item$$1.accelerator = accelerator;
  return item$$1;
}
function createMainWindow() {
  ...
  var filemenu = function filemenu() {
    return ch("yes");
  };

  var newFileMenu = function newFileMenu() {
    return newMenu(Array.from([filemenu()]), "File");
  };

  var template = Array.from([newFileMenu()]);
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ch", function() { return _Main_fs__WEBPACK_IMPORTED_MODULE_0__["ch"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "newMenu", function() { return _Main_fs__WEBPACK_IMPORTED_MODULE_0__["newMenu"]; });
